  ...
  return (
    <div className='bg-gray-900 p-10 rounded-md'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start'>
        <div className='md:mr-6 md:flex-shrink-0 mb-6 md:mb-0'>
        ...
        <div className='flex-grow'>
          ...
          <div className='flex items-center mb-2'>
            ...
            {post.autor.avatarURL && (
              <img src={post.autor.avatarURL} alt={`${post.autor.username}'s Avatar`} className='avatar w-6 h-6 rounded-full object-cover ml-2' />
            )}
          </div>
        ...
        {comments.map((comment) => (
          <li key={comment._id}>
            <div className='bg-gray-800 p-4 rounded-md mb-4'>
              <div className='flex items-center text-white rounded-md mb-2'>
